 ...
 * Use: signup page - Credential user only register
...
export class SignupComponent implements OnInit {
  ...
  /**
   * @function enterEmailSearch
   * @description if exist user means, we display the popup window and login with further details
