...
@Component({
  selector: 'app-securestudentlog',
  templateUrl: './securestudentlog.component.html',
  styleUrls: ['./securestudentlog.component.css']
})
export class SecurestudentlogComponent implements OnInit {
