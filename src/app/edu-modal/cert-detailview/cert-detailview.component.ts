...
@Component({
  selector: 'app-cert-detailview',
  templateUrl: './cert-detailview.component.html',
  styleUrls: ['./cert-detailview.component.css']
})
export class CertDetailviewComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CertDetailviewComponent>,
